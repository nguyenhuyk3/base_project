...
namespace Motel.Utility.Momo
{
    public class MomoSecurity
    {
        ...
        public string GetHash(string partnerCode, string merchantRefId,
                                string amount, string paymentCode,
                                ...
                                string publicKeyXML)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider(4096)) // KeySize
            {
                try
                {
                    ...
                    // You must convert it to XML format.
                    // Recommend tool: https://superdry.apphb.com/tools/online-rsa-key-converter
